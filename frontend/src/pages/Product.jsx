    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>Explore our latest clothing collection featuring premium fabrics, modern designs, and perfect fits. From casual wear to elegant outfits, shop styles that match your personality. Enjoy secure checkout, fast delivery, and effortless style every day.</p>
